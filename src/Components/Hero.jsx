          ...
          <div className="lg:container md:px-3 py-5 lg:py-[30px] lg:pb-[20px]">
            <div className="mx-auto max-w-[860px]">
              <h1 className="text-[24px] md:text-4xl mb-6">
                I'm Joseph. Product and UX <span className="text-[#525866] font-fraunces">Designer</span>
              </h1>
              ...
              <p className="text-[#525866] mb-2 text-lg">I’m looking for a role where I can lead product thinking, support design strategy, and contribute to a strong, user-focused design culture. I’m excited to work with teams that value ownership, fast collaboration, and building products that truly matter.</p>
              ...
              <p className="text-gray-400 text-[14px] text-center mb-2">Companies I have worked with</p>
              <div className="bg-[#FFF8F3] p-4 w-fit mx-auto rounded-2xl">
                <div className="flex justify-center lg:justify-around items-center gap-7 flex-wrap">
                  <img src={hubtelImg} alt="" className="w-auto h-auto object-cover" />
                  <img src={dataware} alt="" className="w-auto h-auto object-cover" />
                  <img src={bitafrika} alt="" className="w-auto h-auto object-cover" />
                  <img src={brolly} alt="" className="w-auto h-auto object-cover" />
                  <img src={kriblinkLogo} alt="" className="w-auto h-auto object-cover" />
