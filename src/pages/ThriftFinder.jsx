    ...
    <div className="my-20">
      <Container>
          ...
          <div className="col-span-1 gap-6">
            ...
            {details.map(({ label, value }, i) => (
              <div key={i} className="flex flex-col gap-2 mb-2">
                <p className="text-[#868C98] text-base">{label}</p>
                <p className="text-[18px] text-gray-600 ">{value}</p>
              </div>
            ))}
          </div>
        </div>
        <div className="bg-gray-100 px-40 py-12 rounded-md mb-16">
          <h4 className="text-2xl font-semibold mb-3">Problem Statement</h4>
        ...
        <div className="grid grid-cols-2 gap-20 items-center mb-16">
          <div>
            <h4 className="text-2xl font-semibold mb-3">Project Goals</h4>
            <ul className="list-disc ps-5">
              <li className="text-base text-gray-700 mb-2">
        ...
        <div className="bg-gray-900 p-10 rounded-md mb-16">
          <h4 className="text-2xl text-white font-semibold mb-3">Research</h4>
          ...
          <ul className="list-disc ps-5">
            ...
            <li className="text-base text-gray-200 mb-2">
        ...
        <div className="grid grid-cols-2 gap-20 mb-16 ">
          <div className=" ">
            <p className="mb-2">The big question is,</p>
          ...
          <div className="mb-8">
            <h4 className="text-2xl font-semibold mb-3">Solution</h4>
            <ul className="list-disc ps-5">
              <li className="text-base text-gray-700 mb-2">
        ...
        <div className="mb-8">
          <h4 className="text-[24px] font-semibold">Designing ThriftFinder</h4>
          <p className="text-gray-700">
        ...
        <div>
          <h4 className="text-xl font-medium mb-1">Onboarding Screens</h4>
          <p className="text-gray-700">
        ...
        <div>
          <h4 className="text-xl font-medium mb-1">Viewing a shop</h4>
          <p className="text-gray-700">
        ...
        <div>
          <h4 className="text-xl font-medium mb-1">Adding a shop</h4>
          <p className="text-gray-700 ">
        ...
        <div className="mb-8">
          <h4 className="text-xl font-medium mb-1">Reviewing a Shop </h4>
          <p className="text-gray-700 ">
        ...
        <div>
          <h4 className="text-[24px] font-medium mb-1">Expected Results </h4>
          <p className="text-gray-700 ">
